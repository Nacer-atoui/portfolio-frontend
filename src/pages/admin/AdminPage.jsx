      ...
      <div className="w-full max-w-[1200px] px-6 pt-16 pb-32 flex flex-col gap-12">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex flex-col gap-1">
            <h1 className="text-blue-950 text-3xl md:text-4xl font-bold font-['Atkinson Hyperlegible'] leading-10">
              Tableau de bord
            </h1>
            <p className="text-zinc-700 text-base font-normal font-['Atkinson Hyperlegible'] leading-6">
        ...
        <div className="w-full bg-white rounded-lg shadow-sm border border-stone-300 flex flex-col overflow-hidden">
          ...
          <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-4 bg-zinc-100 border-b border-stone-300">
            <div className="col-span-6 text-slate-600 text-xs font-bold font-['Atkinson Hyperlegible'] leading-3 tracking-wide uppercase">
              Titre du projet
            </div>
            <div className="col-span-3 text-slate-600 text-xs font-bold font-['Atkinson Hyperlegible'] leading-3 tracking-wide uppercase">
              Catégorie
            </div>
            <div className="col-span-3 text-right text-slate-600 text-xs font-bold font-['Atkinson Hyperlegible'] leading-3 tracking-wide uppercase">
              Actions
            </div>
          </div>
          ...
          {/* Lignes du tableau */}
          {projects.length === 0 ? (
            <div className="p-8 text-center text-slate-600 font-['Atkinson Hyperlegible']">Aucun projet trouvé. Créez votre premier projet !</div>
          ) : (
              ...
              {projects.map((project) => (
                ...
                >
                  ...
                  <div className="md:col-span-6">
                    <h2 className="text-zinc-900 text-base md:text-lg font-semibold font-['Atkinson Hyperlegible'] leading-7">
                      {project.title}
                    </h2>
                  </div>
                  ...
                  <div className="md:col-span-3 flex items-center">
                    <span className="px-3 py-1 bg-zinc-100 border border-stone-300 rounded-sm text-slate-600 text-xs font-bold font-['Atkinson Hyperlegible'] leading-3 tracking-wide uppercase">
                  ...
                  <div className="md:col-span-3 flex flex-wrap justify-start md:justify-end gap-2 mt-4 md:mt-0">
                    ...
                    >
                      ...
                      <span className="text-blue-950 text-xs font-bold font-['Atkinson Hyperlegible'] leading-3 tracking-wide uppercase">
                        Modifier
                      </span>
                    </Link>
                    ...
                    <button 
                      ...
                      className="px-4 py-2 bg-rose-200 hover:bg-rose-300 transition-colors rounded-sm flex items-center gap-2 cursor-poAtkinson Hyperlegible"
                    >
                      ...
                      <span className="text-red-800 text-xs font-bold font-['Atkinson Hyperlegible'] leading-3 tracking-wide uppercase">
                        Supprimer
                      </span>
                    </button>
