...
export function EditProjectPage() {
  ...
  useEffect(() => {
    ...
    fetchProjectEdit();
  }, [id]); // J'ai ajouté reset et apiFetch aux dépendances par bonne pratique React !
  ...
  // Conditions de chargement avec le style sombre
  if (loading) return <main style={mainStyle}><p style={{ color: "#D4AF37", fontSize: "1.2rem" }}>Chargement du projet...</p></main>;
  if (error) return <main style={mainStyle}><p style={{ color: "#ff6b6b", fontSize: "1.2rem" }}>Erreur : {error}</p></main>;
  if (!projectEdit) return <main style={mainStyle}><p style={{ color: "#a0a0a0", fontSize: "1.2rem" }}>Projet introuvable.</p></main>;
  ...
  return (
    <main className="form-container" style={mainStyle}>
      ...
      <h1 style={{ 
        ...
        Modifier le <span style={{ color: "#D4AF37" }}>Projet</span>
      </h1>
        ...
        <div>
          ...
          <textarea
            ...
            {...register("description", {
              required: "La description est obligatoire.", // Ajouté pour la cohérence
              maxLength: {
                value: 2000,
